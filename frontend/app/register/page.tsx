...
export default function RegisterPage() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Creates your business account and your Owner login in one step."
      maxWidth="md"
    >
      {googleCredential ? (
        <>
          <div className="flex items-center justify-between rounded-lg bg-accent-soft px-3 py-2 text-sm">
