...
export async function POST(request: NextRequest) {
  ...
  // The client gets everything except the raw token — that goes straight
  // into an httpOnly cookie instead, so it's never in a place client JS
  // (or an XSS payload) could read it.
